...
当前版本 v0.5.4 已发布，补充规划承诺、正文详略、跨章审稿和评估规则，完整套件为七个技能、33 个文件。[版本说明](releases/v0.5.4.md) · [统一安装指引](../INSTALL.md)。本版面向 macOS／Linux；Windows 导出的已知 WinError 32 未修，Windows 继续使用 v0.4.0，已用新版写入的书先完整备份，不盲目降级。

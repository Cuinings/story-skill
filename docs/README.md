...
文档版本：v0.5.1。本版沿用 7 个技能入口和具名分卷正文，完整套件为 33 个载荷文件，新增作品深读规范、按需分析样例，以及分析稿修订和断点续跑说明。[v0.5.1 版本说明](releases/v0.5.1.md) 汇总变化；固定标签、Release 附件、远端 CI 和 Packages 的实际状态逐项登记在 [发布验证记录](github-release.md)。

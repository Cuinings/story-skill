...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 6,821 | 77.98% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 9,008 | 70.92% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 6,821 | 34.55% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 5,010 | 44.31% |
| 深读示范：含按需分析对照样例 | 8,996 | 7,019 | 21.98% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 2,919 | 74.25% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 4,249 | 62.51% |

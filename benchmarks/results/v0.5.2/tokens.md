...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 6,324 | 79.59% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 8,511 | 72.53% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 6,324 | 39.32% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 4,959 | 44.88% |
| 深读示范：含按需分析对照样例 | 8,996 | 6,968 | 22.54% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 2,868 | 74.7% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 4,198 | 62.96% |

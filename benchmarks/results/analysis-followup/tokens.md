...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 5,330 | 82.79% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 7,097 | 77.09% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 5,330 | 48.86% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 4,518 | 49.78% |
| 深读示范：含按需分析对照样例 | 8,996 | 6,527 | 27.45% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 2,716 | 76.04% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 4,046 | 64.3% |

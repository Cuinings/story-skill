...
|---|---:|---:|---:|
| 长篇单章：明确必读指令下限 | 30,979 | 4,509 | 85.44% |
| 多线超长篇：含完整超长篇附加流程 | 30,979 | 6,149 | 80.15% |
| 短篇：上游仅入口 vs 新版入口与流程 | 10,422 | 4,509 | 56.74% |
| 长篇拆文：上游仅入口 vs 新版入口与流程 | 8,996 | 2,184 | 75.72% |
| 审稿：上游仅入口 vs 新版入口与流程 | 11,334 | 2,422 | 78.63% |
| 冲突与看点审查：含中文场景参考 | 11,334 | 3,752 | 66.9% |
